        ...
        <div class="bg-white p-6 rounded-lg shadow-lg">
            ...
            <form action="{{ route('alumni_profiles.update', $alumniProfile->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    @if ($alumniProfile->profile_pic)
                        <img src="{{ asset('storage/' . $alumniProfile->profile_pic) }}" alt="Profile Picture" class="mt-2 w-24 h-24 object-cover rounded-full">
                    @endif
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" class="mt-1 block w-full" value="{{ old('name', $alumniProfile->name) }}" />
                ...
                <div class="mb-4">
                    ...
                    <textarea name="who_am_i" id="who_am_i" class="mt-1 block w-full">{{ old('who_am_i', $alumniProfile->who_am_i) }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="about_me" id="about_me" class="mt-1 block w-full">{{ old('about_me', $alumniProfile->about_me) }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="location" id="location" class="mt-1 block w-full" value="{{ old('location', $alumniProfile->location) }}" />
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" id="email" class="mt-1 block w-full" value="{{ old('email', $alumniProfile->email) }}" />
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="phone_number" id="phone_number" class="mt-1 block w-full" value="{{ old('phone_number', $alumniProfile->phone_number) }}" />
                ...
                <div class="mb-4">
                    ...
                    <input type="url" name="github_link" id="github_link" class="mt-1 block w-full" value="{{ old('github_link', $alumniProfile->github_link) }}" />
                ...
                <div class="mb-4">
                    ...
                    <input type="url" name="linkedin_link" id="linkedin_link" class="mt-1 block w-full" value="{{ old('linkedin_link', $alumniProfile->linkedin_link) }}" />
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="company_name" id="company_name" class="mt-1 block w-full" value="{{ old('company_name', $alumniProfile->company_name) }}" />
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="position_held" id="position_held" class="mt-1 block w-full" value="{{ old('position_held', $alumniProfile->position_held) }}" />
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="startWork_year" id="startWork_year" class="mt-1 block w-full" value="{{ old('startWork_year', $alumniProfile->startWork_year) }}" />
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="endWork_year" id="endWork_year" class="mt-1 block w-full" value="{{ old('endWork_year', $alumniProfile->endWork_year) }}" />
                ...
                <div class="mb-4">
                    ...
                    <textarea name="roles" id="roles" class="mt-1 block w-full">{{ old('roles', $alumniProfile->roles) }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="institution_name" id="institution_name" class="mt-1 block w-full" value="{{ old('institution_name', $alumniProfile->institution_name) }}" />
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="course_done" id="course_done" class="mt-1 block w-full" value="{{ old('course_done', $alumniProfile->course_done) }}" />
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="startCourse_year" id="startCourse_year" class="mt-1 block w-full" value="{{ old('startCourse_year', $alumniProfile->startCourse_year) }}" />
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="endCourse_year" id="endCourse_year" class="mt-1 block w-full" value="{{ old('endCourse_year', $alumniProfile->endCourse_year) }}" />
                ...
                <div class="mb-4">
                    ...
                    <textarea name="skills" id="skills" class="mt-1 block w-full">{{ old('skills', $alumniProfile->skills) }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="languages" id="languages" class="mt-1 block w-full">{{ old('languages', $alumniProfile->languages) }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="hobbies" id="hobbies" class="mt-1 block w-full">{{ old('hobbies', $alumniProfile->hobbies) }}</textarea>
