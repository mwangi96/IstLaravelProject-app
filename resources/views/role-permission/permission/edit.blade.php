            ...
            <div class="w-full max-w-lg">
                ...
                <div class="bg-white shadow-md rounded-lg">
                    <div class="bg-gray-100 px-6 py-4 border-b border-gray-200">
                        <h4 class="text-lg font-semibold">Edit Permission
                            <a href="{{ url('permissions') }}" class="bg-red-500 text-white py-2 px-4 rounded float-right hover:bg-red-600">Back</a>
                        </h4>
                    </div>
                    <div class="p-6">
